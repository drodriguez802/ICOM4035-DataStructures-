 ...
 *
 */
public class NodePositionListCustomIterator<T> implements PositionList<T> {

	private DNode<T> header, trailer; 
	private int count; 
	
	public NodePositionListCustomIterator() {
	...
	public Iterable<Position<T>> positions() {
		NodePositionListCustomIterator<Position<T>> pList = new NodePositionListCustomIterator<Position<T>>(); 
		try { 
			if (!this.isEmpty()) { 
	...
	private static class DNode<T2> implements Position<T2> {
        ...
        private NodePositionListCustomIterator<T2> myList;     // list it belongs to
        
        public DNode(T2 e, DNode<T2> p, DNode<T2> n, NodePositionListCustomIterator<T2> list) { 
        	element = e; 
        	next = n; 
        	prev = p; 
        	myList = list; 
		...
		public void setList(NodePositionListCustomIterator<T2> n) { 
			myList = n; 
		}
		public NodePositionListCustomIterator<T2> getList() { 
			return myList; 
		}
