...
public class SLRIndexList<E> implements IndexList<E> {
    ...
    public E get(int index) throws IndexOutOfBoundsException {
        if (index < 0 || index >= size)
            throw new IndexOutOfBoundsException("SLRIndexList.get: invalid index = " + index);
    ...
    public void add(int index, E e) throws IndexOutOfBoundsException {
        if (index < 0 || index > size)
            throw new IndexOutOfBoundsException("SLRIndexList.add: invalid index = " + index);
    ...
    public E remove(int index) throws IndexOutOfBoundsException {
        if (index < 0 || index >= size)
            throw new IndexOutOfBoundsException("SLRIndexList.remove:invalid index = " + index);
    ...
    public E set(int index, E e) throws IndexOutOfBoundsException {
        if (index < 0 || index >= size)
            throw new IndexOutOfBoundsException("SLRIndexList.set: invalid index = " + index);
    ...
    private static <E> SNode<E> recAdd(SNode<E> f, int i, E e) {
        // TODO
        if (i == 0) {
            SNode<E> newE = new SNode<E>(e, f);
            return newE;
        } else {
            SNode<E> newE = recAdd(f.getNext(), i - 1, e);
            f.setNext(newE);
            return f;
        }
    }
    ...
    private static <E> E recSet(SNode<E> f, int index, E e) {
        ...
        if (index == 0) {
            ...
            E setT = recSet(f.getNext(), index - 1, e);
            return setT;
        }
    }
     ...
     * 
     * @param cmp
     *            the comparator object. It establishes the relation order upon
     *            which the ordering will be based.
     **/
    ...
    /**
     * Inserts a new node into the sll whose first node is given and assumed
     * ordered in non-decreasing order based on the order implied by a
     * comparator given.
     * 
     * @param <E>
     * @param nti
     *            the node to insert
     * @param first
     *            the first node of the list where the insertion is to take
     *            place. The list is assumed sorted.
     * @param cmp
     *            the comparator upon which the sorting is based
    ...
    /**
     * Reverses the content of the list. The elements of the list will be
     * repositioned in the opposite order as they are
     */
